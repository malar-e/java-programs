...
public class ArrayDequeEx { // won't allow null values
    public static void main(String[] args) {
        ...
        System.out.println("\nequals(): " + deque.equals(dequeCopy)); // Both should be from same interface like deque<> else return false - order, duplicates matters and checks reference.
