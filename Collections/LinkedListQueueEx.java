...
public class LinkedListQueueEx {
    public static void main (String[] args) {
        ...
        System.out.println("Removed element null? " + queue.remove(null));
        ...
        System.out.println("\nequals(): " + queue.equals(queueCopy)); // Both should be from same interface like Queue<> else return false - order and duplicates matters
