...
public class ArrayListEx {
    public static void main(String[] args) {
        ...
        List<Integer> numbersCopy = numbers; // Any changes made to one array will also affect the other
        ...
        brands.add("Honda");
        brands.add("Mahindra");
        brands.addAll(2, cars);
        brands.clear();
        brands.addAll(cars);
        brands.add("Toyota");

        // Cloning
        ArrayList brands2 = (ArrayList) brands.clone(); // clone() belongs to ArrayList<> class. we can't use it in a variable which is declared as List<>
        List brands3 = (ArrayList) brands.clone();
        System.out.println("\nCars List: " + cars);
        ...
        // retainAll + removeIf
        ArrayList<String> cars2 = new ArrayList<>(List.of("Volvo", "BMW", "Ford", "Mazda", "Toyota"));
        ArrayList<String> valid = new ArrayList<>(List.of("Volvo", "Ford", "Mazda"));
        ...
        cars2.sort(Collections.reverseOrder()); // reverse order sort
        System.out.println("Final sorted cars2 in reverse order: " + cars2);
