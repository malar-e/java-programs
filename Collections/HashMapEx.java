...
public class HashMapEx {
    public static void main(String[] args) {
        ...
        Map carPricesCopy1 = (HashMap) carPrices.clone(); // clone() belongs to HashMap<> class. we can't use it in a variable which is declared as Map<>
        ...
        Map<String, Integer> carPricesCopy2 = new HashMap<>();
