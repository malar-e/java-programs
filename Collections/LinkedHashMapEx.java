...
public class LinkedHashMapEx {
    public static void main(String[] args) {
       ...
       System.out.println("Price of Toyota: " + carPrices.get("Toyota")); // returns null since Toyota is not in the map
        ...
        System.out.println("Removed null? " + carPrices.remove(null));
        ...
        Map carPricesCopy1 = (LinkedHashMap) carPrices.clone(); // clone() belongs to LinkedHashMap<> class. we can't use it in a variable which is declared as Map<>
        ...
        Set<Map.Entry<String, Integer>> entrySet = carPrices.entrySet();
        ...
        Map<String, Integer> carPricesCopy2 = new LinkedHashMap<>();
