...
public class StringBuilderEx {
    public static void main(String[] args) {
        ...
        StringBuilder sb3 = new StringBuilder("gen digital");
        CharSequence cs1 = "norton lifelock";
        StringBuilder sb4 = new StringBuilder(cs1);
        CharSequence cs2 = new StringBuilder("avast");

        // Print initial builders and sequences
        System.out.println("string builder 1: " + sb1);
        System.out.println("string builder 2: " + sb2);
        System.out.println("string builder 3: " + sb3);
        System.out.println("string builder 4: " + sb4);
        System.out.println("char sequence 1: " + cs1);
        System.out.println("char sequence 1: " + cs1.toString());
        System.out.println("char sequence 2: " + cs2);
        ...
        sb.append(new StringBuffer(" + StringBuffer"));  // StringBuffer
